# Wave 10 — Quasarr Contract Minter batch planner (extracted formulas + port status)

Source: decompiled `Quasarr.Infrastructure.ContractMinter/ContractMinterBatchPlanner.cs`
