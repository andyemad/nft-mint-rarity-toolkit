...
## Symptom Emad flagged ("why is this here")
...
Note the card itself was legitimate — Emad's own FAB 4200 auto-mint queue,
...
2. Rebuild + `launchctl kickstart -k gui/$(id -u)/com.patelai.rh-mint-room`.
