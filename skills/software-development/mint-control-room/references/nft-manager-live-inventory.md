...
## First real-use fixes (8/24 evening — the user's live session)

the user's first hands-on use found: consolidate errored (`invalid network
...
the user; feature is complete and validated (750/750 tests, tsc clean).

## Slug-from-URL bug (fixed 8/24 late — "No tokens owned across 14 wallets")

the user pasted an OpenSea collection URL into the inspector; inventory returned
