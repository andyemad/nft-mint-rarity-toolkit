...
## What was wrong (symptoms the user flagged)
...
## Verification checklist after the control room UI/API edits
...
4. `npm run build` then `launchctl kickstart -k gui/$(id -u)/com.the agent.rh-mint-room`.
