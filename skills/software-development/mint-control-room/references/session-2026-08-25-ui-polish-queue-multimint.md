...
Session-specific detail for the the control room umbrella. All items were implemented,
...
the user ruled (standing instruction): RH chain gas is effectively free; keep the
...
spend needing the user's explicit OK. If tokens DID land, say exactly which wallet
