# Unified completion planning for the control room

Use this when merging an older implementation plan with a newer agent handoff or delegating the control room work to a weaker coding model.
...
the control room has two distinct paths:
