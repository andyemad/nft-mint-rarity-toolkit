...
E2E: `/api/nft-inventory?collection=<testcollection URL with /overview>` returns
...
- the test collection gates ownerOf normally but returned a real owner for eth_call —
