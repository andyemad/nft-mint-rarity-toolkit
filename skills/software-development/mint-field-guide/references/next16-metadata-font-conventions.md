...
## Worked example (eCalm Suites rebrand)
...
`cp /tmp/ecalm_logo.png public/ecalm-logo.png` → `mv src/app/favicon.png src/app/icon.png`
→ `rm src/app/favicon.ico` → optional `sips -z 180 180 public/ecalm-logo.png --out src/app/apple-icon.png`.
Full spec: `research/ECALM-BRAND-SYSTEM.md` in the repo.
