# the case-study collection ICP metadata — session facts (2026-08-20/21)

Project: `~/Documents/Playground/casestudy-icp-metadata` (NOT the
mint-market-dashboard repo; no git commits there per Playground AGENTS.md).
...
- Next step when the user approves: merge draft into normalized catalog + canister
