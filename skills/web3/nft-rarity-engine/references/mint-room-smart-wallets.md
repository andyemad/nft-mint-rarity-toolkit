...
Feature: Mint Room tracks 159 externally-published "smart money" NFT wallets,
...
2. `launchctl kickstart -k gui/501/com.patelai.rh-mint-room`, wait for `/api/status` 200.
